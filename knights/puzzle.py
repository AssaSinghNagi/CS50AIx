...
# All A, B, C can't be both knave and knight
basicKnowledge = And(
    # not <=> equal to Exclusive Or
...
knowledge3 = And(
    basicKnowledge,
    # not <=> is same as Exclusive or
    Not(Biconditional(Biconditional(AKnight, AKnight), Biconditional(AKnight, AKnave))),
